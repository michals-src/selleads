...
const PlaceholderWrapper2 = ({clientId}) => {
	...
	const handleCreate = ( cols ) => {
		...
		let tree = Array(cols).fill( ['selleads/column'] );
	...
	<>
		<InspectorControls>
            <PanelBody>
				...
				<ColorPalette
					...
					colors={ colors }
					value={ colorParent }
					onChange={ ( color ) => setAttributes( { colorParent: color } ) }
				/>
				...
				<ColorPalette
					...
					colors={ colors }
					value={ colorColumns }
					onChange={ ( color ) => setAttributes( { colorColumns: color } ) }
				/>

                <RangeControl
					label="Zaokrąglenie zbiornika"
					value={ radiusParent }
					onChange={ ( value ) => setAttributes( { radiusParent: value } ) }
					min={ 0 }
					max={ 50 }
				/>
                ...
                <RangeControl
					...
					value={ radiusColumns }
					onChange={ ( value ) => setAttributes( { radiusColumns: value } ) }
					min={ 0 }
					max={ 50 }
				/>
                ...
                <RangeControl
                    ...
                    value={ paddingParent }
                    onChange={ ( value ) => { setAttributes( { paddingParent: value } ) } }
                    min={ 0 }
                    max={ 60 }
                />
                ...
                <RangeControl
                    ...
                    onChange={ ( value ) => { setAttributes( { paddingColumns: value } ) } }
                    min={ 0 }
                    max={ 60 }
                />
		...
		<div className="columns-parent" 
			style={{
				...
				borderRadius: `${radiusParent}px`
			}}>
				<div className="columns-container"
				style={{
					padding: `${paddingColumns}px`,
					backgroundColor: colorColumns,
					borderRadius: `${radiusColumns}px`
				}}>
